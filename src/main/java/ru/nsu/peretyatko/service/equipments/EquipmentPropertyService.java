...
public class EquipmentPropertyService {
    ...
    public Page<EquipmentPropertyResponse> getEquipmentProperties(int page, int size) {
        Pageable pageable = PageRequest.of(page, size);
        return equipmentPropertyRepository.findAll(pageable).map(equipmentPropertyMapper::toEquipmentPropertyResponse);
    }
